...
class TabTransformer(Model):
    def __init__(self, num_numerical_features, num_categorical_features=0, 
                 embed_dim=32, num_heads=4, num_transformer_blocks=3, 
                 mlp_hidden_dims=[128, 64], dropout_rate=0.1, **kwargs):
